...
elseif (isset($_POST['eq']) && isset($_POST['field']))
{
	...
	$_POST['eq'] = Piping::pipeSpecialTags($_POST['eq'], PROJECT_ID, null, null, null, USERID, true);
	...
	// Check if calculation is valid
	$logic = Piping::pipeSpecialTags($_POST['eq'], null, null, null, null, USERID, true, null, $Proj->metadata[$_POST['field']]['form_name']);
