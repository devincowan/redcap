...
// Query logging table
$sql = "SELECT * FROM ".Logging::getLogEventTable($project_id)."
...
if ($fp && $result)
{
	...
	while ($row = db_fetch_assoc($result))
	{
		...
		fputcsv($fp, Logging::renderLogRow($row, false));
	}
	...
	// Logging
	Logging::logEvent($sql, Logging::getLogEventTable($project_id),"MANAGE",$project_id,"project_id = $project_id","Export entire logging record");
