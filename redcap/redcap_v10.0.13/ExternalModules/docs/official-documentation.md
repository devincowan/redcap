...
**[Click here](framework/intro.md) for method documentation.**
...
The publicly supported methods that module creators may utilize depend on the framework version they opt into via the configuration file and are documented [here](framework/intro.md).
