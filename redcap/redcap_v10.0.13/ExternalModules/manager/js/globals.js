...
ExternalModules.Settings.prototype.initializeRichTextFields = function(){
	...
	tinymce.init({
		...
		toolbar1: 'undo redo | insert | styleselect | bold italic | alignleft aligncenter alignright alignjustify | outdent indent | bullist numlist | table | forecolor backcolor | searchreplace fullscreen code',
		toolbar_groups: {
			insert: {
				icon: 'plus',
				tooltip: 'Insert',
