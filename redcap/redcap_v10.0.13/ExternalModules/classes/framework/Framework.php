...
class Framework
{
	...
	function getRecordIdField($pid = null){
        ...
        return ExternalModules::getRecordIdField($pid);
	}
	...
	*/
    ...
    // Pass through for any method was added in framework version 5.
    // We initially allowed pass through for any method without a framework version, but this caused problems when deploying modules uses
    ...
    public function isSafeToForwardMethodToFramework($name){
        ...
        // Always allow these methods, because they've always been callable from AbstractExternalModules directly since they were added.
        $isGrandfatheredMethodForward = in_array($name, [
            "tt", 
        ...
        return $isGrandfatheredMethodForward;
    }
